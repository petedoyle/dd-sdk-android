...
package co.fast.android.internal.datadog.android.utils.assertj
...
internal class DeserializedLongTaskEventAssert(actual: LongTaskEvent) :
    AbstractAssert<DeserializedLongTaskEventAssert, LongTaskEvent>(
        actual,
        DeserializedLongTaskEventAssert::class.java
    ) {
    ...
    companion object {
        fun assertThat(actual: LongTaskEvent): DeserializedLongTaskEventAssert {
            return DeserializedLongTaskEventAssert(actual)
        }
    }
}
