...
package co.fast.android.internal.datadog.opentracing.propagation;
      ...
      try {
        ...
        for (final Map.Entry<String, String> entry : carrier) {
          ...
          if (TRACE_ID_KEY.equalsIgnoreCase(key)) {
            ...
            traceId = HttpCodec.validateUInt64BitsID(trimmedValue, HEX_RADIX);
          } else if (SPAN_ID_KEY.equalsIgnoreCase(key)) {
            spanId = HttpCodec.validateUInt64BitsID(value, HEX_RADIX);
